...
public class NumberofperiodsServiceImpl implements NumberofperiodsService {
	 ...
	 */
	@Override
	public Page<NumberOfPeriodsPageListBean> getCustomPageList(String sql, String param) {
		// 创建分页对象
		PageRequest page = PageSort.pageRequest();
		Page<Object[]> customPageList = numberofperiodsRepository.getCustomPageList(sql, param, page);
		return null;
	}
